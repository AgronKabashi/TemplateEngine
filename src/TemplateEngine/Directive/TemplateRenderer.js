				...
				function (DataBagService)
				{
					return {
						...
						template: function (element, attributes)
						{
							...
							var nameAttribute = !isEditMode ? "" : 'data-friendly-name="{{TemplateControl.FriendlyName}}" data-control-name="{{TemplateControl.ControlName}}"';
							var styleAttribute = !isEditMode ? "" : 'ng-attr-style="{{TemplateControl.VisualProperties}}"';
							...
							return String.format(
								...
								</div>', nameAttribute, styleAttribute)
						}
					};
				}
			]);
