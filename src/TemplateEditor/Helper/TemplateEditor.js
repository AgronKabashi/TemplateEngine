define(
	...
	function (angular)
	{
		return angular
			...
			.service("Cerberus.Tool.TemplateEditor.Helper.TemplateEditor", function ($timeout)
			{
					...
					templateElement
						.droppable(
						{
							...
							drop: function (event, ui)
							{
								...
								setTimeout(function () { self.EnableDraggableResizableSelectable(scope, templateElement); }, 50);
							}
						});
				};
